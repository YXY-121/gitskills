...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public UserModel getUserByCache(Integer id) {
        UserModel model = (UserModel) redisTemplate.opsForValue().get("user_" + id);
        if(model==null){
            model=this.getUserById(id);
            redisTemplate.opsForValue().set("user_"+id,model);
